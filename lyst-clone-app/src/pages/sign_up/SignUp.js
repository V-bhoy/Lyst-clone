    ...
    <div className="sign-up-container">
      <div className="sign-up__content-container">
        ...
        >
          ...
          <div className="rgi">
              <div><label  className="rgl"  htmlFor="sign-up__email">Name</label></div>
              <input
                type="text"
                name="name"
            ...
            <div className="rgi">
              <div><label  className="rgl"  htmlFor="sign-up__email">Mobile Number</label></div>
              <input
                type="number"
                name="number"
            ...
            <div className="rgi">
              <div><label  className="rgl"  htmlFor="sign-up__email">Email Address</label></div>
              <input
                type="email"
                name="email"
            ...
            <div className="rgi">
              <div><label  className="rgl"  htmlFor="sign-up__password">Password</label></div>
              <input
                type="password"
                name="password"
            ...
            <div className="rgi">
              <div><label  className="rgl"  htmlFor="sign-up__confirm-password">
                Confirm Password
              </label></div>
              <input
                type="text"
            ...
            <div className="rgc">
              <input type="checkbox"/> 
              <label> I would like to hear about products, services, and sales, including personalized email alerts from Lyst. You can unsubscribe at any time.</label>
            </div>
            ...
            <div className="tc">
              <p>By creating an account, you consent to Lyst’s Terms & Conditions. To learn more about how Lyst uses and protects your personal data, please read Lyst’s Privacy Policy.</p>
            </div>
