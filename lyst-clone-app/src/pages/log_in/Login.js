        ...
        <div className="login__content-container">
          ...
          >
            {/* <fieldset className="login-form__input-container"> */}
              ...
              <div>
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZO3Gz6oas3O8s0v1EXPW_Axv9AUi1gBVnPbQcOzsVqOjMXcxqQuNV-0pl90g6H1z0dw&usqp=CAU" alt="none" width="99%" height="30px" className={styles.imgrg}/>
              </div>
